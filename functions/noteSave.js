exports = async function (request, response) {
  ...
  try {
    ...
    await cameItems.map(item => {
      ...
      if(typeof item.AB_sonuc !== "string" && item.AB_sonuc.length !== 0 || typeof item.AB_sonuc == "number"  ) {
      ...
      if(typeof item.G_sonuc !== "string" && item.G_sonuc.length !== 0 || typeof item.G_sonuc == "number"  ) {
      ...
      if(typeof item.G_sonuc2 !== "string" && item.G_sonuc2.length !== 0 || typeof item.G_sonuc2 == "number"  ) {
